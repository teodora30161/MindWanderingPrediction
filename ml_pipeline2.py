...
def save_results_by_config(config, mean_metric, fold_metrics, feature_importances, feature_names, output_dir='.'):
    ...
    return metrics_file, imp_file, plot_file
...
def save_overall_confusion_matrix(config, all_y_true, all_y_pred, output_dir='.'):
    ...
    plot_file = os.path.join(config_dir, "confusion_matrix_overall.png")
    plt.savefig(plot_file)
    plt.close()
...
if __name__ == "__main__":
    ...
    # Load your data
    df = pd.read_csv("/Users/teostei/Desktop/MINDWANDERINGDEEPLEARNING/big_window_combined_behavior_eye_features_labeled.csv")
